...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { description: @plate.description, image: @plate.image, name: @plate.name, portions: @plate.portions, price: @plate.price } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { description: @plate.description, image: @plate.image, name: @plate.name, portions: @plate.portions, price: @plate.price } }
